...
ggplot(penguins, aes(x = flipper_length_mm, y = body_mass_g, color = species)) +
  geom_point() + 
  labs(title = "Basic plot", y = "Body Mass", x = "Flipper length") +
  theme_minimal()
```
...
ggplot(penguins, aes(x = species, y = body_mass_g)) +
  geom_violin() +
  labs(title = "Distribution of body masses",
       subtitle = "Data source: palmerpenguins package",
       x = "Species",
...
# X axes differ  between the two options
```
...
```{r}
# YOUR CODE HERE
ggplot(subset(df, country == "Brazil" | country == "India" | country == "China" | country == "South Africa"),
       aes(y = lifeExp, x = year)) +
  geom_line() +
  labs(title = "Distribution of life expectancy 1952-2007 for BRICS countries",
       subtitle = "Data source: Gapminder package",
       x = "Life expectancy in years",
       y = "Density") +
  theme_bw() +
