...
gridExtra::grid.arrange(basic_scatter, advanced_scatter, ncol = 2)
```
...
2.  Add `fill = "#FF6666"` (or type "red" instead of "#FF6666")
3.  Change the geom to `_density` and `_bar`
4.  Consider what data would be good to display in a box plot or violin plot

```{r, fig.show="hold",  warning=F, echo=F, message=F}
...
```{r, fig.show="hold",  warning=F, message=F, echo=F}
...
:::{.alert-info .pad-box}
It might be a good investment to [create a personalized color palette](https://rfortherestofus.com/2023/01/how-to-make-your-own-color-palettes-in-ggplot).I like to use tools that help me implement graphic design best practices, for example [Adobe Color](https://color.adobe.com/create/color-wheel)
:::
