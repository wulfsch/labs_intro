...
```{r, echo= FALSE}
# your code here
paste("life_expectancy ~", "gdp +", "population +", "alcohol") |> 
  as.formula() |> 
  lm(data = life_expec_dat)

paste("life_expectancy ~", "gdp *", "population +", "alcohol") |> 
  as.formula() |> 
  lm(data = life_expec_dat)

paste("life_expectancy ~", "gdp +", "I(gdp^2) +", "I(log(population))") |> 
  as.formula() |> 
  lm(data = life_expec_dat)
```
:::
...
# your code here
for (i in 1:3) {
  print(summary(multiv_model_out[[i]]))
}
```
:::
...
```{r, echo= FALSE}
options(scipen = 999)
my_table <- modelsummary::modelsummary(multiv_model_out[29:31], 
                                        output = "kableExtra",
