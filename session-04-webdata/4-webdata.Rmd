...
```
:::alert-info
**Exercise 5** In the example sentence can you find all the words that are less than 6 characters long?
```{r}
# Your code here
```
:::
:::alert-info
**Exercise 6** How many words are there in `stringr::words` that end with a "y" and are exactly 3 characters long?
