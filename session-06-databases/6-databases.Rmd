...
```{r}
unregistered <- anti_join(flights, planes, by = "tailnum") |> 
...
# If we wanted to write this back to the database, we could add another pipe operator with copy_to, leaving out the df variable.
```
...
new_year <- left_join(flights_db, airlines_db, by = "carrier") |> 
